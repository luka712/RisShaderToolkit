namespace RisShaderToolkit.Tests
{
    ...
    public class SlangToWgslTests
    {
        ...
        public void TestCompileSlangToWgsl()
        {
            ...
            // Act
            CompileResult result = compiler.CompileSlangToWgsl(inputFilePath, shaderStages, ["main_vs", "main_fs"]);
        ...
        public void TestCompileSourceCodeSlangToWgsl()
        {
            ...
            // Act
            CompileResult result = compiler.CompileSlangSourceCodeToWgsl(slangSourceCode, [ShaderStage.VERTEX, ShaderStage.FRAGMENT], ["main_vs", "main_fs"]);
            Assert.True(result.Success);
        }
